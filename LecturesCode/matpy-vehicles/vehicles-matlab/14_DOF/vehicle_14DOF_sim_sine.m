...
%% sine wave steering anlge input 0.0087(rad) and Vx=33.73(m/s)
clc;
clear all;
...
%% steering angle input: sine wave steer angle input 0.0087(rad) and Vx=33.73
for i=1:11000
if i<1000
    delta2(i)=0;
else
    delta2(i)=0.5*pi/180*sin(1/3*2*pi*0.001*(i-1000));
end
end
